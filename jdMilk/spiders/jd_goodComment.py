...
from jdMilk.items import commentItem
import json
import xlrd
...
class comment_spider(Spider):
    ...
    data = xlrd.open_workbook("goodComments.csv")
    # goods为要抓取评论的商品信息，现提供一个goodComments.csv文件供参考,第1列：商品ID；第2列：商品评论数；第3列：商品的commentVersion
    # test.xlsx也可以使用
    table = data.sheets()[0]
